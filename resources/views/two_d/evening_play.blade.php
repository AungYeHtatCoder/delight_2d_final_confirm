    ...
    <div class="balance container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 mx-auto">
                <div class="text-white sticky-top p-2" style="background: #1aacac; ">
                ...
                <div class="d-flex mt-3 text-center">
                    <div class="col-lg-6">
                        <div class="d-flex">
                            ...
                            <span class="font-green" id="userBalance"
                                data-balance="{{ Auth::user()->balance }}">လက်ကျန်ငွေ - {{ Auth::user()->balance }}
                                </span>

                        </div>
                        <span class="font-green font-13">MMK -  (ကျပ်)</span>
                    </div>
                    <div class="col-lg-6">
                        <div class="d-flex">
                            <img src="{{ asset('user_app/assets/img/balance/time.png') }}" alt=""
                                style="width: 25px; height: 25px;"><span class="font-green">ပိတ်ရန်ကျန်ချိန်</span>
                        </div>
