                    ...
                    <form action="{{ route('admin.two-d-play.store') }}" method="post" class="p-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="selected_digits" id="selected_digits outputField"  class="form-control" placeholder="Enter digits">
                            </div>
                            <div id="amountInputs" class="col-md-12 mb-3"></div>
                            
                            <div class="col-md-12 mb-3">
                                <input id="outputField_ch" class="form-control text-center digit digit-button " data-digit="{{ $digit->two_digit }}" ... >
                            </div>
...
//         let newDigitInput = document.createElement("input");
//         newDigitInput.type = "text";
//         newDigitInput.className = "digitInput";
//         newDigitInput.setAttribute("maxlength", "2");
//         newDigitInput.setAttribute("placeholder", "Enter two digits");
//         newDigitInput.setAttribute("onkeyup", "checkLength(this)");
        
//         let newAmountInput = document.createElement("input");
//         newAmountInput.type = "text";
//         newAmountInput.className = "amountInput";
//         newAmountInput.setAttribute("placeholder", "Amount for this digit");
        
//         let container = document.getElementById("inputContainer");
//         container.appendChild(newDigitInput);
//         container.appendChild(newAmountInput);
//     }
// }
    ...
    //     // Highlight the digit within the loop
    //     selectDigit(input.value);
