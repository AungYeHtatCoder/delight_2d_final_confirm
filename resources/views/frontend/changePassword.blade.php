...
@section('content')
<h6 class="text-center p-3 font-weight-bold" style="color: #1aacac;">လျှို့ဝှက်နံပါတ်ပြောင်းမည်</h6>
<div class="container">
 ...
 <div class="form-group">
  <a href="" class="pw-btn btn">ပြောင်းမည်</a>
 </div>
</div>
</div>
<div class="row m-2">
<div class="col-lg-4 mx-auto font-weight-bold" style="color: #1aacac;">
